...
export default async function ReportsPage() {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen w-full bg-[#111111] p-6 text-white md:p-10">
        <main className="container mx-auto">
          <h1 className="mb-8 text-3xl font-bold">Meus Relatórios (DARF)</h1>
          <Card className="border-none bg-[#1C1C1C]">
            <CardHeader>
              <CardTitle>Histórico de Impostos Gerados</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
